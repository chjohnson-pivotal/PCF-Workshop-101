...
. Open a new browser tab and navigate to https://metrics.run.haas-72.pez.pivotal.io[https://metrics.run.haas-72.pez.pivotal.io] to open the PCF Metrics page for this PCF instance.
+
