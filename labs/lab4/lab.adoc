...
. Go back to the Apps Manager and click on the Overview Tab for the workshop application
+
image::app-mgr-overview.png[]
+
. Click on the View in PCF Metrics link, located in the Status section. You will need to click through the SSL security warnings. The Metrics dashboard is shown. 
+
