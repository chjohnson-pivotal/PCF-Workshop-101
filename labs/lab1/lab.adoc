...
+
----
$ cf api https://api.run.haas-90.pez.pivotal.io/ --skip-ssl-validation
----
...
urls: workshop-philologic-catchpolery.vert.fe.gopivotal.com <11>
...
. Visit the application in your browser by hitting the route that was generated by the CLI. This is the url listed in output identified by the callout 11 above. You will need to find this in your own output as your URL will be different.
+
image::lab-java.png[]
