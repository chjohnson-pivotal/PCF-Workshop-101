...
urls: nodejs-portless-lummox.vert.fe.gopivotal.com <14>
...
. Visit the application in your browser by hitting the route that was generated by the CLI. This is the url listed in output identified by the callout 14 above. You will need to find this in your own output as your URL will be different.
+
image::lab-node.png[]
